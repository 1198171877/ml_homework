...
def get_parser():
    ...
    # model type
    parser.add_argument('--atten', type=str, default='LightweightAttention', help='Path to save the trained model')
    ...
    parser.add_argument('--save_model_path', type=str, default='./checkpoints_lht', help='Path to save the trained model')
